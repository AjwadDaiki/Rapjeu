...
export function LeThemeMode({
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8">
      ...
      >
        <p className="text-sm text-gray-400 mb-2">Le Th̬me</p>
      ...
      {isMyTurn ? (
        <form onSubmit={handleSubmit} className="w-full max-w-md">
          ...
          {teammateInput && (
            ...
            >
              <span className="text-xs text-gray-400">Co̩quipier tape:</span>
        ...
        <div className="text-center text-gray-400">
          {teammateInput ? (
            <div className="px-4 py-3 bg-gray-800 rounded-lg">
              <span className="text-sm text-gray-500">Votre ̩quipe pr̩pare:</span>
            ...
            >
              <p className="text-lg">L'̩quipe adverse joue...</p>
            </motion.div>
          )}
        </div>
      )}
