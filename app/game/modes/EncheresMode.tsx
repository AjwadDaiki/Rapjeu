    ...
    return (
      <div className="flex flex-col items-center justify-center h-full p-8 relative">
        ...
        <div className="flex items-center gap-3 mb-4 relative z-10">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-500/30 border border-yellow-400/50">
            <span className="w-3 h-3 rounded-full bg-yellow-400 animate-pulse" />
            <span className="text-yellow-200 font-bold text-sm uppercase tracking-wider">{'\u00c9tape 1/2 : Mise'}</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
            <span className="w-3 h-3 rounded-full bg-gray-600" />
            <span className="text-gray-500 font-bold text-sm uppercase tracking-wider">{'\u00c9tape 2/2 : Preuve'}</span>
          </div>
        </div>

        <div className="text-gray-200 mb-8 text-center max-w-md relative z-10 font-semibold space-y-2">
          <p className="text-base">
            {'\uD83C\uDFB0 Misez combien de r\u00e9ponses vous connaissez.'}
          </p>
          <p className="text-sm text-gray-400">
            {'Chaque \u00e9quipe mise en secret \u2192 la plus haute mise devra prouver !'}
          </p>
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 relative">
      ...
      <div className="flex items-center gap-3 mb-4 relative z-10">
        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10">
          <span className="w-3 h-3 rounded-full bg-gray-600" />
          <span className="text-gray-500 font-bold text-sm uppercase tracking-wider">{'\u2705 Mise'}</span>
        </div>
        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/30 border border-green-400/50">
          <span className="w-3 h-3 rounded-full bg-green-400 animate-pulse" />
          <span className="text-green-200 font-bold text-sm uppercase tracking-wider">{'\u00c9tape 2/2 : Preuve'}</span>
        </div>
      </div>
