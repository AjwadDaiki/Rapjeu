...
export default function GamePage() {
  ...
  const pulsePalette = {
    ...
    dup: {
      glow: '0 0 40px rgba(242, 201, 76, 0.35)',
          ...
          {answerPulse && (
            ...
            >
              <motion.div
                ...
                style={{ background: answerPulse.tone === 'bad' ? 'rgba(239, 68, 68, 0.08)' : answerPulse.tone === 'dup' ? 'rgba(242, 201, 76, 0.08)' : 'rgba(34, 197, 94, 0.08)' }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
