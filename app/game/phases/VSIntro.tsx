...
export function VSIntro({ teamAPlayers, teamBPlayers, onComplete }: VSIntroProps) {
  useEffect(() => {
    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] relative overflow-hidden">
      ...
      >
        <div className="text-center">
          <h2 className="text-4xl font-bold text-blue-400 mb-4">ÉQUIPE A</h2>
      ...
      >
        <div className="text-center">
          <h2 className="text-4xl font-bold text-red-400 mb-4">ÉQUIPE B</h2>
          <div className="flex flex-wrap justify-center gap-2">
