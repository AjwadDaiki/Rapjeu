          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {!canEditConfig && (
              <div className="lg:col-span-2 text-center text-xs uppercase tracking-[0.2em] text-slate-400">
                Visible pour tous â€¢ Modifiable par l'hÃ´te uniquement
              </div>
            )}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      ...
      <motion.div
        ...
        className="w-full max-w-md bg-white/5 backdrop-blur-2xl rounded-3xl p-8 border border-white/10 shadow-[0_30px_90px_rgba(15,23,42,0.55)] relative z-10"
        style={{
          boxShadow: '0 30px 90px rgba(10, 14, 24, 0.65)',
        }}
      >
        ...
        <p className="text-center text-slate-300 mb-8 tracking-[0.18em] uppercase text-xs">
          Le quiz rap multijoueur en temps rÃ©el
        </p>
