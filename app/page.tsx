  ...
  return (
    <>
      ...
      <div className="sa-page" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        >
          <div className="sa-logo sa-logo-xl" style={{ margin: 0, justifyContent: 'center' }}>
            <span className="sa-logo-rap">RAP</span>
            <span className="sa-logo-jeu">JEU</span>
            <span className="sa-logo-tag">MULTI</span>
          </div>
          <motion.p
            ...
            style={{ fontSize: '16px', marginTop: '12px', color: 'rgba(255,255,255,0.85)' }}
          >
            QUIZ RAP BATTLE &middot; MULTIJOUEUR
          </motion.p>
        </motion.header>
